...
import com.example.clientapp.Models.QuestionModel;
import com.example.clientapp.databinding.ActivityQuestionBinding;
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if(snapshot.exists()) {
                            ...
                            if (list.size() > 0) {
                                ...
                                Toast.makeText(QuestionActivity.this, "вопрос не существует", Toast.LENGTH_SHORT).show();
                            }
