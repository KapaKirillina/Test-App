package com.example.finalappadmin;
...
import com.example.finalappadmin.Adapter.QuestionsAdapter;
import com.example.finalappadmin.Models.QuestionModel;
import com.example.finalappadmin.databinding.ActivityAddQuestionBinding;
import com.example.finalappadmin.databinding.ActivityQuestionBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new QuestionsAdapter(this, list, categoryName, new QuestionsAdapter.DeleteListener() {
            ...
            public void onLongClick(int position, String id) {
                ...
                builder.setMessage("Вы уверены, что хотите удалить этот вопрос?");
                    ...
                    database.getReference().child("Sets").child(categoryName).child("questions")
                            .child(id).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void unused) {
                                    Toast.makeText(QuestionActivity.this, "Вопрос удален", Toast.LENGTH_SHORT).show();
                                }
                            });
                        ...
                        .addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                if(snapshot.exists()){
                                    ...
                                    Toast.makeText(QuestionActivity.this, "Вопросы не существуют", Toast.LENGTH_SHORT).show();
