...
import com.example.finalappadmin.Adapter.CategoryAdapter;
import com.example.finalappadmin.Models.CategoryModel;
import com.example.finalappadmin.databinding.ActivityMainBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        database.getReference().child("categories").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()){
                    ...
                    Toast.makeText(MainActivity.this, "Урок не существует", Toast.LENGTH_SHORT).show();
                }
        ...
        uploadCategory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(imageUri == null){
                    Toast.makeText(MainActivity.this, "Загрузите изображение", Toast.LENGTH_SHORT).show();
                }
